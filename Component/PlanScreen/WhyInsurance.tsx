    ...
    const why = [
        {
            ...
            title: 'Affordable',
            subtitle:'Plans start as low as $5/month - less than a coffee! Pay only for what you need.',
        },

        {
            ...
            title: 'Transparent',
            subtitle:"No confusing jargon. We clearly show what's covered and what's not.",
        },
    ]
